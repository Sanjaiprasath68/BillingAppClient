...
const ProductTable = () => {
  ...
  const handleAddSubmit = async () => {
    ...
    try {
      const response = await axios.post('https://online-billing-app.vercel.app/items', {
  ...
  const handleEditSubmit = async () => {
    ...
    try {
      const response = await axios.put(`https://online-billing-app.vercel.app/items/${editProduct._id}`, {
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`https://online-billing-app.vercel.app/items/${id}`);
